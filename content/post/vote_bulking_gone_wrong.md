...
[View on GitHub](https://github.com/iluvmOne-Y/Boosting_Lan_Song_Xanh2025)
...
Here is the rule: **1 Verified Account = 1 Free Vote per Day (worth 5 points).**

Most people saw a voting form. I saw a challenge. And since I really wanted my favorite actor take the top spot(don't judge my dedication), I needed more than just _my_ vote. I needed an army.

## The Exploit: "The Infinite Email Glitch"

In the first three days of voting, I noticed that: The website allowed registration with **any** email address, not just Gmail. You just needed to verify it.
...
I wrote some script to simulate _me_ sitting at the computer.

The first things to make this work is defind each UI button location
so with the help of displayMousePosition(), it was a good helper

Some others useful function like hotkey(), press(), click()

and the most advance techinique is locateOnScreen() func which use openCV to
detect an image

In this case, after login, if the unvertify alert popup, the openCV dectect and just
skip to the next accout
...
- **The Payload:** $700 \times 5 = 3,500$ points per day.
...
After three days, the Dev Team at Lan Song Xanh apparently woke up. They dropped the ban hammer: **Registration and Login is now restricted to Gmail accounts only.**

Just like that, my factory of temp-mail accounts became useless

## What Next?

My 700 soldiers are is all XXXXXX.

Am I giving up?
I don't know... but **THERE A WILL,THERE A WAY.**

_To be continued... or not_
